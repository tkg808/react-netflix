    ...
    <div className="landing-page-container">
      <header className="landing-page-header-container">
        <div className="landing-page-header-content">
          ...
          <div className="landing-page-header-lang-container">
            <div className="lang-switcher-container">
              <label htmlFor="lang-switcher-header-select">
                <span>Select Language</span>
              </label>
              <div className="lang-switcher-select-container">
                <select name="lang-switcher-header" id="lang-switcher-header-select">
          ...
          <Link to="/login" className="landing-page-header-signin-link">
            Sign In
          </Link>
        </div>
      </header>
